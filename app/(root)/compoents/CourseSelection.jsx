...
const CourseSelection = () => {
    return (
        <section className="w-full flex justify-center px-4 md:px-0 mt-8 mb-16">
            <div className="w-full max-w-[1784px] h-[920px] bg-[#FFFFFF] rounded-[40px] relative z-10 p-8 md:p-14 flex flex-col justify-center">
                {/* Header */}
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
                    <div className="max-w-[511px]">
                        <h2 className="text-[40px] leading-[136%] font-medium text-[#1A0B10] font-montserrat tracking-[-0.04em] capitalize">
